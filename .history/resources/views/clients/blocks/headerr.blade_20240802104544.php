                                            ...
                                            <ul class="dropdown-list">
                                                @if(auth()->check())
                                                    ...
                                                    <li>
                                                        ...
                                                        <form action="{{ route('san_pham.index') }}" method="POST" id="logout-form">
                                                            @csrf
                                                            <a href="{{ route('admins.sanpham.index') }}"><button type="submit" style="background: none; border: none; cursor: pointer;">Admin</button></a>
